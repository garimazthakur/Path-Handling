...
Path9 =os.path.join(os.path.dirname(os.path.abspath(__file__)), "Files")  #to get the 
Path10 = os.path.dirname("Paths") ##will not give any output because we have not given absolute path to it 
Path11= os.path.dirname(os.path.abspath("Paths"))  #Now we will get the dirname of "FileHandeling "folder
